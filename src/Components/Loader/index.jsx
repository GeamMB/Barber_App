		...
		<>
			<section className="min-h-screen bg-[#16232E]">
				...
				<div className="max-w-3xl mx-auto lg:hidden">
					<div className="min-h-screen flex justify-center items-center bg-gradient-to-b from-[#1F303F] to-[#477194]">
						<div role="status">
							<svg aria-hidden="true" className="h-12 w-12 animate-spin fill-[#E3C75F] text-[#f5f5f5]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
